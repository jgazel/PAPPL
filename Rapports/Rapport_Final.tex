...
\lettrine{L}{'importance} de la programmation concurrente n'a cessé de croître depuis quelques années. Sa connaissance et sa maîtrise deviendront à terme une nécessité pour tous les développeurs au regard du besoin de parallélisation des tâches.\\
...
Notre travail a donc consisté à prendre en main ces bibliotèques, voire le langage pour Scala, puisque nous le connaissions peu avant ce projet.\\
...
On remarque bien que les processus dépendent de leur place dans la sélective, et leur ordre est, sauf exceptions, quasiment le même.
