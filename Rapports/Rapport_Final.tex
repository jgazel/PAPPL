...
\lettrine{S}{ous la} supervision de notre encadrant M.\ \textsc{Roux}, nous nous sommes penchés sur CSO -- Communcating Scala Objects. Ce language est une extension de Scala, et permet d'implémenter tout algorithme de programmation concurrentielle.\\
