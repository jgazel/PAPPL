...
\lettrine{\`A}{près plusieurs} semaines sur les deux langages, il appara\^it que CSO est bien plus compliqué que JCSP; d'une part par la prise en main du langage de programmation Scala, d'autre part à cause de sa syntaxe particulière pour les \emph{channels synchrones}.\\
